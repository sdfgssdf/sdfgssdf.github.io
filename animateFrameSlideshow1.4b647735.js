...
;
},{"gsap":"QSxm"}],"DNuh":[function(require,module,exports) {
"use strict";
...
new _animateFrameSlideshow.slideShow(document.querySelector('.slideshow'));
(0, _imagesloaded.default)('.slide__img', {
  background: true
}, function () {
  return document.body.classList.remove('loading');
});
},{"imagesloaded":"oZ3m","./animateFrameSlideshow":"bMwt"}]},{},["DNuh"], null)