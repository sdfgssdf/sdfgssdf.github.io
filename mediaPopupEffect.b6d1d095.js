...
},{"./gsap-core.js":"OKU8","./CSSPlugin.js":"QIAl"}],"MgTz":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.areClipPathShapesSupported = areClipPathShapesSupported;
...
function areClipPathShapesSupported() {
  var base = 'clipPath',
      ...
      attribute = 'polygon(50% 0%, 0% 100%, 100% 100%)'; // Push the prefixed properties into the array of properties.
  ...
  for (var i = 0, l = properties.length; i < l; i++) {
    var property = properties[i]; // First, they need to even support clip-path (IE <= 11 does not)...
...
;
},{}],"tEhi":[function(require,module,exports) {
"use strict";
...
var MediaRevealer = /*#__PURE__*/function () {
  function MediaRevealer(el) {
    _classCallCheck(this, MediaRevealer);

    this.el = el;
    this.contentEl = (0, _utils.findAncestor)(this.el, 'content');
    this.mediaEl = this.contentEl.querySelector('.pop-media[data-pop-media="' + this.el.getAttribute('data-pop-media') + '"]'); // Check if any data-pop-width and data-pop-height values were passed.
  ...
  _createClass(MediaRevealer, [{
    key: "positionMedia",
    value: function positionMedia() {
...
function initEvents() {
  ...
  var t3 = new MediaRevealer((0, _utils.$)('trigger-3'));
  ...
  var t11 = new MediaRevealer((0, _utils.$)('trigger-11'));
  ...
  var t13 = new MediaRevealer((0, _utils.$)('trigger-13'));
...
if ((0, _utils.areClipPathShapesSupported)()) {
  document.body.classList.add('clip-path-polygon');
} // setTimeouts for the mouseenter events.


var triggertimeout,
    triggerdelay = 50; // Preload all images.

(0, _imagesloaded.default)(document.querySelector('.content'), {
  background: true
}, function () {
  document.body.classList.remove('loading');
  initEvents();
});
},{"imagesloaded":"oZ3m","gsap":"QSxm","./utils":"MgTz"}]},{},["tEhi"], null)