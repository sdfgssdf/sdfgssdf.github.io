...
},{"./gsap-core.js":"OKU8","./CSSPlugin.js":"QIAl"}],"bMwt":[function(require,module,exports) {
"use strict";
  ...
  _createClass(slideShow, [{
    ...
    value: function calculatePath() {
      ...
      if (path === 'initial') {
        ...
        return {
          next: "M 0,0 0,".concat(this.rect.height, " ").concat(this.rect.width, ",").concat(this.rect.height, " ").concat(this.rect.width, ",0 0,0 Z M ").concat(this.frameSize, ",").concat(this.frameSize, " ").concat(this.rect.width - this.frameSize, ",").concat(this.frameSize / 2, " ").concat(this.rect.width - this.frameSize, ",").concat(this.rect.height - this.frameSize / 2, " ").concat(this.frameSize, ",").concat(this.rect.height - this.frameSize, " Z"),
          prev: "M 0,0 0,".concat(this.rect.height, " ").concat(this.rect.width, ",").concat(this.rect.height, " ").concat(this.rect.width, ",0 0,0 Z M ").concat(this.frameSize, ",").concat(this.frameSize / 2, " ").concat(this.rect.width - this.frameSize, ",").concat(this.frameSize, " ").concat(this.rect.width - this.frameSize, ",").concat(this.rect.height - this.frameSize, " ").concat(this.frameSize, ",").concat(this.rect.height - this.frameSize / 2, " Z")
        };
      }
    }
  }, {
    ...
    value: function navigate() {
      ...
      var animateShapeIn = _gsap.default.to(this.DOM.shape, {
        duration: this.settings.animation.shape.duration,
        ease: this.settings.animation.shape.easing.in,
        attr: {
      ...
      var animateSlides = function animateSlides() {
        return new Promise(function (resolve, reject) {
          ...
          _gsap.default.to(currentSlide, {
            ...
            ease: _this2.settings.animation.slides.easing,
          ...
          _gsap.default.fromTo(newSlide, {
            translateX: dir === 'next' ? _this2.rect.width : -1 * _this2.rect.width
          }, {
            duration: _this2.settings.animation.slides.duration,
            ease: _this2.settings.animation.slides.easing,
            translateX: 0
          ...
          _gsap.default.killTweensOf(newSlideImg);

          _gsap.default.fromTo(newSlideImg, {
            translateX: dir === 'next' ? 200 : -200
          }, {
          ...
          _gsap.default.fromTo([newSlide.querySelector('.slide__title'), newSlide.querySelector('.slide__desc'), newSlide.querySelector('.slide__link')], {
            translateX: dir === 'next' ? 300 : -300,
            opacity: 0
          }, {
      ...
      var animateShapeOut = function animateShapeOut() {
        _gsap.default.to(_this2.DOM.shape, {
          duration: _this2.settings.animation.shape.duration,
          delay: 0.15,
          ease: _this2.settings.animation.shape.easing.out,
          attr: {
      ...
      animateShapeIn.then(animateSlides).then(animateShapeOut);
    }
  }]);
...
;
},{"gsap":"QSxm"}],"nYEP":[function(require,module,exports) {
"use strict";

var _imagesloaded = _interopRequireDefault(require("imagesloaded"));

var _animateFrameSlideshow = require("./animateFrameSlideshow");
...
var slideShow1 = /*#__PURE__*/function (_slideShow) {
  _inherits(slideShow1, _slideShow);

  var _super = _createSuper(slideShow1);

  function slideShow1() {
    _classCallCheck(this, slideShow1);

    return _super.apply(this, arguments);
  }

  _createClass(slideShow1, [{
    key: "calculatePath",
    value: function calculatePath() {
      var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'initial';
      ...
      if (path === 'initial') {
        ...
        return {
          next: "M 0,0 0,".concat(this.rect.height, " ").concat(this.rect.width, ",").concat(this.rect.height, " ").concat(this.rect.width, ",0 0,0 Z M ").concat(this.frameSize, ",").concat(this.frameSize, " ").concat(this.rect.width - this.frameSize, ",").concat(this.frameSize, " ").concat(this.rect.width - this.frameSize, ",").concat(this.rect.height - this.frameSize, " ").concat(this.frameSize, ",").concat(this.rect.height - this.frameSize, " Z"),
          prev: "M 0,0 0,".concat(this.rect.height, " ").concat(this.rect.width, ",").concat(this.rect.height, " ").concat(this.rect.width, ",0 0,0 Z M ").concat(this.frameSize, ",").concat(this.frameSize, " ").concat(this.rect.width - this.frameSize, ",").concat(this.frameSize, " ").concat(this.rect.width - this.frameSize, ",").concat(this.rect.height - this.frameSize, " ").concat(this.frameSize, ",").concat(this.rect.height - this.frameSize, " Z")
        };
      }
    }
  }, {
    ...
    value: function createFrame() {
      ...
      this.DOM.svg.setAttribute('height', '100%');
      this.DOM.svg.setAttribute('viewbox', "0 0 ".concat(this.rect.width, " ").concat(this.rect.height));
      this.DOM.svg.innerHTML = "<path fill=\"white\" d=\"".concat(this.paths.initial, "\"/>");
      this.DOM.el.insertBefore(this.DOM.svg, this.DOM.nav);
      this.DOM.shape = this.DOM.svg.querySelector('path');
    }
  }]);
  ...
  return slideShow1;
}(_animateFrameSlideshow.slideShow);

new slideShow1(document.querySelector('.slideshow'));
(0, _imagesloaded.default)('.slide__img', {
  background: true
}, function () {
  return document.body.classList.remove('loading');
});
},{"imagesloaded":"oZ3m","./animateFrameSlideshow":"bMwt"}]},{},["nYEP"], null)