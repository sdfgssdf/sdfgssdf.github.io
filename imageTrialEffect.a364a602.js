...
},{"./gsap-core.js":"OKU8","./CSSPlugin.js":"QIAl"}],"ixdS":[function(require,module,exports) {
"use strict";
...
var Image = /*#__PURE__*/function () {
  ...
  _createClass(Image, [{
    ...
    value: function resize() {
      // reset styles
      _gsap.TweenMax.set(this.DOM.el, this.defaultStyle); // get sizes/position
...
var ImageTrail = /*#__PURE__*/function () {
  ...
  _createClass(ImageTrail, [{
    ...
    value: function showNextImage() {
      ...
      _gsap.TweenMax.killTweensOf(img.DOM.el);

      new _gsap.TimelineMax() // show the image
      .set(img.DOM.el, {
        opacity: 1,
...
var preloadImages = function preloadImages() {
  return new Promise(function (resolve, reject) {
    (0, _imagesloaded.default)(document.querySelectorAll('.content__img'), {
      background: true
    }, resolve);
  });
}; // And then..
...
},{"imagesloaded":"oZ3m","gsap":"QSxm"}]},{},["ixdS"], null)